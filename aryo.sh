...
https://raw.githubusercontent.com/saputribosen/template-marzq/refs/heads/main/depend/marzban.sh
#Install Marzban
sudo bash -c "$(curl -sL https://raw.githubusercontent.com/saputribosen/template-marzq/main/depend/marzban.sh)" @ install

#Install Subs
wget -N -P /var/lib/marzban/templates/subscription/  https://raw.githubusercontent.com/saputribosen/template-marzq/main/www/index.html

#install env
wget -O /opt/marzban/.env "https://raw.githubusercontent.com/saputribosen/template-marzq/main/env"
...
wget -O /usr/bin/profile "https://raw.githubusercontent.com/saputribosen/template-marzq/main/welcome";
chmod +x /usr/bin/profile
apt install neofetch -y
wget -O /usr/bin/cekservice "https://raw.githubusercontent.com/saputribosen/template-marzq/main/cekservice.sh"
chmod +x /usr/bin/cekservice

#install compose
wget -O /opt/marzban/docker-compose.yml "https://raw.githubusercontent.com/saputribosen/template-marzq/main/docker-compose.yml"

#Install VNSTAT
apt -y install vnstat
/etc/init.d/vnstat restart
apt -y install libsqlite3-dev
wget https://github.com/saputribosen/aryoxban/raw/main/vnstat-2.6.tar.gz
...
wget -O /opt/marzban/nginx.conf "https://raw.githubusercontent.com/saputribosen/aryoxban/main/nginx.conf"
wget -O /opt/marzban/default.conf "https://raw.githubusercontent.com/saputribosen/aryoxban/main/vps.conf"
wget -O /opt/marzban/xray.conf "https://raw.githubusercontent.com/saputribosen/aryoxban/main/xray.conf"
mkdir -p /var/www/html
echo "<pre>Setup by AutoScript Aryo</pre>" > /var/www/html/index.html
...
wget -O /var/lib/marzban/xray_config.json "https://raw.githubusercontent.com/saputribosen/aryoxban/main/xray_config.json"
...
#install database
wget -O /var/lib/marzban/db.sqlite3 "https://github.com/saputribosen/aryoxban/raw/main/db.sqlite3"

#install WARP Proxy
wget -O /root/warp "https://raw.githubusercontent.com/saputribosen/aryoxban/main/warp/install_warp_proxy.sh"
...
password  : ${passpanel}
-=================================-
Diskusi di Channel & Grup Telegram:
- Channel: https://t.me/aryobrokoly
- Group: https://s.id/gruparyo
